...
public class ArithmeticOperators {
    ...
    public static void main(String[] args) {
        ...
        int remainder = num1 % num2;//remainder variable contains the remainder od num1 divided by  num2

        // 10 divide by 3 is equal to 3 with a remainder of 1

        System.out.println(num1 +" divided by " + num2);
        System.out.println(num1 + " divided by " + num2 + " is equal to " + division + " with a remainder");
